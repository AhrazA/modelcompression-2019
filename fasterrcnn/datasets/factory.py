...
__sets = {}
from fasterrcnn.datasets.pascal_voc import pascal_voc
from fasterrcnn.datasets.coco import coco
from fasterrcnn.datasets.imagenet import imagenet
from fasterrcnn.datasets.vg import vg
